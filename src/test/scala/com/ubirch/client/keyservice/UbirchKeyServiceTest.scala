...
class UbirchKeyServiceTest extends FlatSpec with Matchers {
  "HttpKeyService" should "fetch and properly deserialize public keys" ignore {
    ...
    keys.get.getRawPublicKey should equal ("97f2897959cef314d7916edb8dff8eba613bbd7c412243c783ce7fb9501b0626")
    keys.get.getPublicKey.getAlgorithm should equal ("Ed25519")
  }
}
